...
#import "MYGradientViewController.h"
#import <objc/runtime.h>


@interface MYGradientViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MYGradientViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"我渐变出来了";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self pushViewController:@"MYLasetViewController"];
}
