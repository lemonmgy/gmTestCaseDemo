...
- (void)clearImageData {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        NSString *alert = [NSString stringWithFormat:@"getSize== %lu getDiskCount =%lu",(unsigned long)[[SDImageCache sharedImageCache] totalDiskSize], (unsigned long)[[SDImageCache sharedImageCache] totalDiskCount]];
        hidden_alert(alert);
